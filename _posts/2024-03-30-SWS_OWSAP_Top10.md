...
## Cryptographic Failures
 ...
 ![alt text](/Screenshot%202024-03-31%20202018.png)
 ...
 ![alt text](/Screenshot%202024-03-31%20202300.png)
...
![alt text](/Screenshot%202024-03-31%20204937.png)
...
![alt text](/Screenshot%202024-03-31%20211604.png)
...
![alt text](<Screenshot%202024-03-31%10211618.png)

after using th green color we get the password which is a high vunleribility.

![alt text](</Screenshot%202024-03-31%20211703.png>)
...
![alt text](</Screenshot%202024-03-31%20212541.png>)
...
![alt text](</Screenshot%202024-03-31%20212609.png>)
...
![alt text](</Screenshot%202024-03-31%20215336.png>)
...
![alt text](</Screenshot%202024-03-31%20215927.png>)
...
![alt text](</Screenshot%202024-03-31%20220012.png>)

we get regestired succesfully and after that we login.

![alt text](</Screenshot%202024-03-31%20220029.png>)
...
![alt text](</Screenshot%202024-03-31%20220104.png>)

to login as aurthur it is same like we did in darren as to give space.

![alt text](</Screenshot%202024-03-31%20220113.png>)
...
![alt text](</Screenshot%202024-03-31%20221008.png>)

we have to get the SHA-256 hash and to get this we can go to SRI hash generator website.

![alt text](</Screenshot%202024-03-31%20220917.png>)
...
the above picture is showing us the encoding and decoding which has different header and playload and signature.
 ...
 ![alt text](</Screenshot%202024-03-31%20224147.png>)
 ...
 ![alt text](</Screenshot%202024-03-31%20225014.png>)
...
![alt text](</Screenshot%202024-03-31%20225301.png>)
